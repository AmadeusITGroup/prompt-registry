...
```json
{
  ...
  "sources": {
    "github-a1b2c3d4": { "type": "github", "url": "..." }
  },
  "hubs": {
    "b5c6d7e8": { "name": "My Hub", "url": "https://example.com/hub.json" }
  }
}
```
...
|---------------|--------|---------|
| Hub source | `{type}-{8-char-hash}` | `github-a1b2c3d4` |
...
3. Take the first 8 characters of the hex digest
...
- **Collision resistance**: 8 hex chars (32 bits) provides sufficient uniqueness
