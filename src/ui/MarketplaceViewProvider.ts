        ...
        try {
            ...
            await vscode.window.withProgress({
                ...
                try {
                    ...
                    throw new Error(`Failed to uninstall current version: ${(uninstallError as Error).message}`);
                }
                ...
                try {
                    ...
                    throw new Error(`Failed to install latest version: ${(installError as Error).message}`);
                }
            });
