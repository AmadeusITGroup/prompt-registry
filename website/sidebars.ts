  ...
  userGuide: [
    {
      ...
      items: [
        ...
        { type: "doc", id: "user-guide/security-scanning", label: "Security Scanning" },
      ],
    },
  ],
  authorGuide: [
      ...
      items: [
        ...
        { type: "doc", id: "contributor-guide/architecture", label: "Architecture" },
        {
          ...
          items: [
            ...
            { type: "doc", id: "contributor-guide/architecture/security-scanner", label: "Security Scanner" },
          ],
        },
        ...
        { type: "doc", id: "contributor-guide/security-scanner-maintenance", label: "Security Scanner Maintenance" },
  ...
  reference: [
    {
      ...
      items: [
        ...
        { type: "doc", id: "reference/security-scanner", label: "Security Scanner" },
      ],
    },
  ],
};
